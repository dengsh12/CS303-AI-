...
class AI(object):
    ...
    def __init__(self, chessboard_size, color, time_out):
        self.score_matrix =     [[-6, -64, 63, 55, 55, 63, -64, -6], [-64, 43, 52, 19, 19, 52, 43, -64], [63, 52, 22, 9, 9, 22, 52, 63],
         [55, 19, 9, -2, -2, 9, 19, 55], [55, 19, 9, -2, -2, 9, 19, 55], [63, 52, 22, 9, 9, 22, 52, 63],
         [-64, 43, 52, 19, 19, 52, 43, -64], [-6, -64, 63, 55, 55, 63, -64, -6]]
        self.score_matrix1 =    [[-3, 22, 3, 53, 53, 3, 22, -3], [22, -4, 50, 43, 43, 50, -4, 22], [3, 50, 53, 28, 28, 53, 50, 3],
         [53, 43, 28, 50, 50, 28, 43, 53], [53, 43, 28, 50, 50, 28, 43, 53], [3, 50, 53, 28, 28, 53, 50, 3],
         [22, -4, 50, 43, 43, 50, -4, 22], [-3, 22, 3, 53, 53, 3, 22, -3]]
        self.c2 = [169, 168, 174]
        self.c3 =[54, 7, 33]
        self.c4=[8, 6, 84]
        self.c5=[-4, -31, -43]
