...
class AI(object):
    ...
    def __init__(self, chessboard_size, color, time_out):
        self.match={}
        self.score_matrix =      [[-24, -3, 44, 11, 11, 44, -3, -24], [-3, 28, 50, 29, 29, 50, 28, -3], [44, 50, 41, 9, 9, 41, 50, 44],
         [11, 29, 9, -10, -10, 9, 29, 11], [11, 29, 9, -10, -10, 9, 29, 11], [44, 50, 41, 9, 9, 41, 50, 44],
         [-3, 28, 50, 29, 29, 50, 28, -3], [-24, -3, 44, 11, 11, 44, -3, -24]]
        self.score_matrix1 =     [[40, 9, 46, 52, 52, 46, 9, 40], [9, 38, 55, 60, 60, 55, 38, 9], [46, 55, 56, 24, 24, 56, 55, 46],
         [52, 60, 24, 38, 38, 24, 60, 52], [52, 60, 24, 38, 38, 24, 60, 52], [46, 55, 56, 24, 24, 56, 55, 46],
         [9, 38, 55, 60, 60, 55, 38, 9], [40, 9, 46, 52, 52, 46, 9, 40]]
